...
<div class="leftContent">
    ...
    <ul class="address">
        ...
        <li><strong>Website:</strong> <a href="http://www.jacksonvilleoregon.org/index.html">www.jacksonvilleoregon.org/</a></li>
    </ul>
    ...
    <ul class="address">
        ...
        <li><strong>Website:</strong> <a href="http://www.magnolia-inn.com">www.magnolia-inn.com</a></li>
    </ul>
    ...
    <ul class="address">
        ...
        <li><strong>Website:</strong> <a href="http://www.stagelodge.com">www.stagelodge.com</a></li>
    </ul>
    ...
    <ul class="address">
        ...
        <li><strong>Website:</strong> <a href="http://www.rogueweb.com/horizoninn/">www.rogueweb.com/horizoninn/</a></li>
    </ul>
    ...
    <ul class="address">
        ...
        <li><strong>Website:</strong> <a href="http://www.rogueweb.com/holidaymedford/">www.rogueweb.com/holidaymedford/</a></li>
    </ul>

    <h3>Primitive Camping at Lily Prarie</h3>
    <p>The Motorcycle Racing Association allows overnight camping at Lily Prairie. There is NO water or bathroom facilities at the prairie.  Please use caution on the road, as low clearance vehicles are NOT recommended.  Follow Jacksonville Reservoir Road (stay to the right at the fork in the road).  Lily Prairie has a large, three tiered parking area. There are a few campsites with fire pits available. Please view <a href="/docroot/img/maps/bikefest.pdf">this map</a> for an area overview and directions for getting to Lily Prairie.  Please be courteous and clean up after yourself.  Thank you!</p>
</div>
