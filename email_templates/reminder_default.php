...
$subject = 'Siskiyou Velo | Your Renewal Date Is Fast Approaching';
$headers = 'From: '.$from . "\r\n" .
    'Reply-To: ' . $from . "\r\n" .
...
<tr valign="top">
	...
	<p>We just wanted to send you a friendly reminder that renewal date of <strong>'.$expire.'</strong> is coming up soon. We hope that you will renew your membership in the Velo. You can renew your membership by logging into your account at <a href="http://www.siskiyouvelo.org">siskiyouvelo.org</a> and clicking on the Renew Now link on the left side of the page, or from the Members Only pulldown menu.</p>
	
	<p>If you have any questions or if you believe this to be in error, please reply to this message and we&rsquo;ll get back to you as soon as possible.</p>
