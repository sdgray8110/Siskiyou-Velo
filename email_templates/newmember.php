...
$subject = 'Welcome To The Siskiyou Velo';
$headers = 'From: '.$from . "\r\n" .
    'Reply-To: ' . $from . "\r\n" .
...
<tr valign="top">
	...
	<p>Thank you for joining the Siskiyou Velo. An electronic membership card is <a href="http://www.siskiyouvelo.org/member_card.php?id='.$memberID.'">available here</a>. Print this out and it can be used at participating bike shops to receive a 10% discount.</p>
	<p>Please review your membership details to the right and follow the instructions to update them if needed.</p>
	<p>For the security of your account, we encourage you to change your password when you log in.</p>
	...
	<p style="font-size:11px;  padding: 0 3px 10px 3px; margin:0;">If any of these details need to be updated, login to the <a href="http://www.siskiyouvelo.org">Siskiyou Velo Website</a> using the primary email address (<em>listed below</em>) and password.</p>
