...
#
# --------------------------------------------------------------------------------------
function sp_ListForumName($args='', $toolTip='') {
...
function sp_ListLastPost($args='', $label='') {
	...
	if ($user) $out.= "<span class='$labelClass'>$lb$poster</span>\n";
	...
	# date/time
	if($niceDate) {
		$out.= "<span class='$labelClass'>$lb".sp_nicedate($spThisListTopic->post_date)."</span>\n";
	} else {
		if ($date) {
			$out.= "<span class='$labelClass'>$lb".sp_date('d', $spThisListTopic->post_date);
			if($time) {
...
function sp_ListFirstPost($args='', $label='') {
	...
	# date/time
	if($niceDate) {
		$out.= "<span class='$labelClass'>$lb".sp_nicedate($spThisListTopic->first_post_date)."</span>\n";
	} else {
		if ($date) {
			$out.= "<span class='$labelClass'>$lb".sp_date('d', $spThisListTopic->first_post_date);
			if($time) {
