...
<?php
	...
	$ttpath = SPHELP.'admin/tooltips/admin-config-color-tips-'.$lang.'.php';
	if (file_exists($ttpath) == false) $ttpath = SPHELP.'admin/tooltips/admin-config-color-tips-en.php';
...
<?php
	...
	echo '<td>';
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Change Admin Color Scheme - Backgrounds'), true, 'change-admin-background-colors', true);
				spa_paint_color_input(spa_text('Submit buttons'), 'submitbg', $sfadminsettings['colors']['submitbg']);
				spa_paint_color_input(spa_text('Tab buttons'), 'bbarbg', $sfadminsettings['colors']['bbarbg']);
				spa_paint_color_input(spa_text('Panel header'), 'panelhead', $sfadminsettings['colors']['panelhead']);
				spa_paint_color_input(spa_text('Forms'), 'formbg', $sfadminsettings['colors']['formbg']);
				spa_paint_color_input(spa_text('Form panels'), 'panelbg', $sfadminsettings['colors']['panelbg']);
				spa_paint_color_input(spa_text('Sub form panels'), 'panelsubbg', $sfadminsettings['colors']['panelsubbg']);
				spa_paint_color_input(spa_text('Form table headings'), 'formtabhead', $sfadminsettings['colors']['formtabhead']);
				spa_paint_color_input(spa_text('Main table headings'), 'tabhead', $sfadminsettings['colors']['tabhead']);
				spa_paint_color_input(spa_text('Main table rows'), 'tabrowmain', $sfadminsettings['colors']['tabrowmain']);
				spa_paint_color_input(spa_text('Sub table rows'), 'tabrowsub', $sfadminsettings['colors']['tabrowsub']);
			spa_paint_close_fieldset();
		spa_paint_close_panel();

		do_action('sph_admins_options_left_panel');
		spa_paint_tab_right_cell();

		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Change Admin Color Scheme - Text'), true, 'change-admin-text-colors', true);
				spa_paint_color_input(spa_text('Submit buttons'), 'submitbgt', $sfadminsettings['colors']['submitbgt']);
				spa_paint_color_input(spa_text('Tab buttons'), 'bbarbgt', $sfadminsettings['colors']['bbarbgt']);
				spa_paint_color_input(spa_text('Panel header'), 'panelheadt', $sfadminsettings['colors']['panelheadt']);
				spa_paint_color_input(spa_text('Forms'), 'formbgt', $sfadminsettings['colors']['formbgt']);
				spa_paint_color_input(spa_text('Form panels'), 'panelbgt', $sfadminsettings['colors']['panelbgt']);
				spa_paint_color_input(spa_text('Sub form panels'), 'panelsubbgt', $sfadminsettings['colors']['panelsubbgt']);
				spa_paint_color_input(spa_text('Form table headings'), 'formtabheadt', $sfadminsettings['colors']['formtabheadt']);
				spa_paint_color_input(spa_text('Main table headings'), 'tabheadt', $sfadminsettings['colors']['tabheadt']);
				spa_paint_color_input(spa_text('Main table rows'), 'tabrowmaint', $sfadminsettings['colors']['tabrowmaint']);
				spa_paint_color_input(spa_text('Sub table rows'), 'tabrowsubt', $sfadminsettings['colors']['tabrowsubt']);
			spa_paint_close_fieldset();
		spa_paint_close_panel();
	...
	echo '<td>';
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Reset Admin Color Scheme'), true, 'reset-admin-colors');
				$values = array(spa_text('Reset to WP blue (Classic)'), spa_text('Reset to WP grey (Fresh)'));
				spa_paint_radiogroup(spa_text('Reset admin color scheme'), 'sfresetcolors', $values, '', false, true);
			spa_paint_close_fieldset();
		spa_paint_close_panel();
