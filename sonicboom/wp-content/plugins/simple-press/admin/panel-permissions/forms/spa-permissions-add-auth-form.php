...
$LastChangedDate: 2012-05-29 12:58:55 -0700 (Tue, 29 May 2012) $
$Rev: 8601 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Create New Authorization'); ?>" />
	</div>
	</form>
