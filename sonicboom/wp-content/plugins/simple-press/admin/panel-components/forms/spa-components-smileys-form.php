...
$LastChangedDate: 2012-02-11 08:20:32 -0700 (Sat, 11 Feb 2012) $
$Rev: 7910 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="updatesmileys" name="saveit" value="<?php spa_etext('Update Smileys Component'); ?>" />
	</div>
	</form>
<?php
}
