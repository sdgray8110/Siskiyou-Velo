...
$LastChangedDate: 2011-12-10 13:29:39 -0700 (Sat, 10 Dec 2011) $
$Rev: 7450 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Avatar Options'); ?>" />
	</div>
	</form>
<?php
}
