...
$LastChangedDate: 2011-11-26 15:38:41 -0700 (Sat, 26 Nov 2011) $
$Rev: 7382 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Profile Tabs and Menus'); ?>" />
	</div>
	</form>
<?php
}
