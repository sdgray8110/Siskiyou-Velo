...
Simple:Press
Admin themes list
$LastChangedDate: 2012-04-29 20:49:53 -0700 (Sun, 29 Apr 2012) $
$Rev: 8465 $
*/
...
?>
	                    <input type="submit" class="button-secondary action" id="saveit-<?php echo esc_attr($theme_file); ?>" name="saveit-<?php echo esc_attr($theme_file); ?>" value="<?php echo spa_etext('Activate Theme'); ?>" />
	                    </form>
					</span>
<?php
