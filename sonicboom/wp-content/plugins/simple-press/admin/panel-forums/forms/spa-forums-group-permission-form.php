...
$LastChangedDate: 2011-07-18 14:17:15 -0700 (Mon, 18 Jul 2011) $
$Rev: 6715 $
*/
...
?>
		...
		<input type="submit" class="sfform-panel-button" id="groupperm<?php echo $group->group_id; ?>" name="groupperm<?php echo $group->group_id; ?>" value="<?php spa_etext('Add Group Permission'); ?>" />
		<input type="button" class="sfform-panel-button" onclick="javascript:jQuery('#group-<?php echo $group->group_id; ?>').html('');" id="grouppermcancel<?php echo $group->group_id; ?>" name="grouppermcancel<?php echo $group->group_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>
	</form>
