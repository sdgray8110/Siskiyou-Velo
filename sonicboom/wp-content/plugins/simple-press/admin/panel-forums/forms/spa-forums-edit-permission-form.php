...
?>
		...
		<input type="submit" class="sfform-panel-button" id="editperm<?php echo $perm->permission_id; ?>" name="editperm<?php echo $perm->permission_id; ?>" value="<?php spa_etext('Update Permission Set'); ?>" />
		<input type="button" class="sfform-panel-button" onclick="javascript:jQuery('#curperm-<?php echo $perm->permission_id; ?>').html('');" id="sfpermissionnedit<?php echo $perm->permission_id; ?>" name="editpermcancel<?php echo $perm->permission_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>
	</form>
