...
$LastChangedDate: 2012-03-24 13:49:54 -0700 (Sat, 24 Mar 2012) $
$Rev: 8214 $
*/
...
?>
					...
					<table class="form-table">
						<tr>
							...
							<td class="sflabel"><?php spa_etext('User Group Badge') ?>:<br />(<?php spa_etext('Upload badges on the Compononts - Forum Ranks admin panel') ?>)</td>
...
?>
		...
		<input type="submit" class="sfform-panel-button" id="sfusergroupedit<?php echo $usergroup->usergroup_id; ?>" name="sfusergroupedit<?php echo $usergroup->usergroup_id; ?>" value="<?php spa_etext('Update User Group'); ?>" />
		<input type="button" class="sfform-panel-button" onclick="javascript:jQuery('#usergroup-<?php echo $usergroup->usergroup_id; ?>').html('');" id="sfusergroupedit<?php echo $usergroup->usergroup_id; ?>" name="editusergroupcancel<?php echo $usergroup->usergroup_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>
	</form>
