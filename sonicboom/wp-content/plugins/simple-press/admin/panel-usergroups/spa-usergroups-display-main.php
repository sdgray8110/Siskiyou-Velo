...
$LastChangedDate: 2011-11-03 22:41:25 -0700 (Thu, 03 Nov 2011) $
$Rev: 7298 $
*/
...
<?php
						...
						$image = SFADMINIMAGES;
?>
						<input type="button" class="button button-highlighted" value="<?php echo splice(spa_text('Edit User Group'),0,0); ?>" onclick="spjLoadForm('editusergroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $usergroup->usergroup_id; ?>');" />
					</td>
					<td style="padding:10px 0;">
						<input type="button" class="button button-highlighted" value="<?php echo splice(spa_text('Delete User Group'),0,0); ?>" onclick="spjLoadForm('delusergroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $usergroup->usergroup_id; ?>');" />
					</td>
				</tr>
