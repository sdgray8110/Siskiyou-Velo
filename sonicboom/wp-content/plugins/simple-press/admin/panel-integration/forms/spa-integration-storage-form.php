...
$LastChangedDate: 2012-04-08 18:46:44 -0700 (Sun, 08 Apr 2012) $
$Rev: 8298 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Storage Locations'); ?>" />
	</div>
	</form>
<?php
