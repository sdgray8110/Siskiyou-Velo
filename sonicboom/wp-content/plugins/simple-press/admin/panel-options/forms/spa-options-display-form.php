...
$LastChangedDate: 2012-03-24 20:22:26 -0700 (Sat, 24 Mar 2012) $
$Rev: 8221 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Display Options'); ?>" />
	</div>
	</form>
<?php
}
