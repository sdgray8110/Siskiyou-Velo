...
$LastChangedDate: 2011-08-12 17:07:14 -0700 (Fri, 12 Aug 2011) $
$Rev: 6874 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Global Options'); ?>" />
	</div>
	</form>
<?php
}
