	...
	spa_paint_open_tab(spa_text('Options').' - '.spa_text('Content Settings'));
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Spam Posts'), true, 'spam-links');
				spa_paint_checkbox(spa_text('Allow links in posts'), 'sfallowlinks', $sfoptions['sfallowlinks']);
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Content Options'); ?>" />
	</div>
	</form>
<?php
}
