...
$LastChangedDate: 2012-02-28 15:03:24 -0700 (Tue, 28 Feb 2012) $
$Rev: 8030 $
*/
...
#== ENVIRONMENT INFO Tab ==========================================================
	...
	$wp_theme = get_theme_data(get_stylesheet_directory().'/style.css');
	...
	spa_paint_open_tab(spa_text('Toolbox')." - ".spa_text('Environment'));
		spa_paint_open_fieldset(spa_text('Environment'), false, '', true);
			...
			spa_env_info(spa_text('Theme'), $wp_theme['Name']);
			spa_env_close();
