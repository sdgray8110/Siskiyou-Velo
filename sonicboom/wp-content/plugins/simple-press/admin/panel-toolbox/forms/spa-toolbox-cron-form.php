...
$LastChangedDate: 2012-06-04 19:05:22 -0700 (Mon, 04 Jun 2012) $
$Rev: 8658 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update CRON'); ?>" />
	</div>
	</form>
<?php
}
