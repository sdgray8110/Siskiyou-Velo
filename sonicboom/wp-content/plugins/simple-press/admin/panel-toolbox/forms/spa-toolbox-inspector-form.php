...
$LastChangedDate: 2011-09-05 01:43:47 +0100 (Mon, 05 Sep 2011) $
$Rev: 6968 $
*/
...
?>
	...
	<input type="submit" class="sfform-panel-button" id="saveit" name="saveit" value="<?php spa_etext('Update Inspector Settings'); ?>" />
	</div>
	</form>
<?php
}
