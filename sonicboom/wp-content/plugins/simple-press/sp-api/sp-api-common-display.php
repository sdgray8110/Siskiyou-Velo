...
Simple:Press
Desc:
$LastChangedDate: 2012-05-26 02:54:45 -0700 (Sat, 26 May 2012) $
$Rev: 8569 $
*/
...
# Version: 5.0
function sp_render_group_forum_select($goURL=false, $valueURL=false, $showSelects=true, $showFirstRow=true, $firstRowLabel='', $id='', $class='') {
	...
	if (empty($class)) $class= 'spControl';
