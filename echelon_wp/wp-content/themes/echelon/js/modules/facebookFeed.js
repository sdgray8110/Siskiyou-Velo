...
(function ($) {
    var settings = {
        ...
        tokenEl: '#fbToken', // as of 5/27/11 facebook's graph api requires a valid app token: http://goo.gl/20eqw
        loadingGif: '/wp-content/themes/echelon/images/util/fb_loader.gif'
    };

    $.fn.fbFeed = function (options) {
        var root = $(this),
            options = $.extend({}, settings, options);
        options.token = $(options.tokenEl).text();
