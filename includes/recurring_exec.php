...
$delete = clean($_POST['delete']);
	...
	//Create insert query
	$qry = "INSERT INTO gray8110_svblogs . sv_recurring(
			date, time, start, start_city, start_link, ride_name, pace, distance, ride_leader, phone, email, nonclub
			)
			VALUES ('$date', '$time', '$start', '$start_city', '$start_link', '$ride_name', '$pace', '$distance', '$ride_leader', '$phone', '$email', '$nonclub')";
