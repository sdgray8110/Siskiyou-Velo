...
if ($spam != '') || if ($comment == '') || if ($email == '') {echo '<p>Your comment appears to contain spam or other malicious content. If you believe this to be in error, please use the contact us page to notify the webmaster.</p>';}
