<form id="schedpage" name="schedpage" method="post"  action="includes/recurring_edit_exec.php">
<?php 
...
$result = mysql_query("SELECT * FROM sv_recurring WHERE ID = $urlID ", $connection);
...
<table class='schedule' width='654' border='0'>
    ...
    <tr>        
        ...
        <td><input id='time' name='time' value='$time' minlength='4' maxlength='10' type='text' /></td>
    </tr>    
</table>
...
<table class='schedule' width='654' border='0'>
    ...
    <tr>      
        <td valign='top'><select id='start_link' name='start_link' type='text'>
...
<table class='schedule' width='654' border='0'>
    ...
    <tr width='50%'>
        <td><input id='ride_name' name='ride_name' value='$ride_name' type='text' /></td>
        <td valign='top'>&nbsp;</td>
	</tr>
    <tr>
    ...
    <tr>        
        <td valign='top'><input id='pace' name='pace' type='text' value='$pace' /></td>
