...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="gastronomistpage">
			...
			<!--update recipe links-->
			<ul class="recipes">
				<li><a href="recipe1.php"><img src="images/links/recipe1.png" border="none" alt="recipe 1"/></a></li>
				<li><a href="recipe1.php"><img src="images/links/recipe2.png" border="none" alt="recipe 2"/></a></li>
				<li><a href="recipe1.php"><img src="images/links/recipe3.png" border="none" alt="recipe 3"/></a></li>
			</ul>
			<!--replace this image with either the recipe card or the food image(s)-->
			<div class="food">
				<img src="images/food/recipe1_image.jpg"  alt="don't it look good!"/>
			</div>
			<!--insert correct arrow-->
			<ul class="arrows">	
				<li><a href="gastronomist.php"><img src="images/arrow2.gif" border="none" alt="recipe ingrdiant(s)"/></a></li>
			</ul>
		</div>
	</body>	
</html>