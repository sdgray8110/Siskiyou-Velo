...
$query = mysql_query("SELECT * FROM wp_users WHERE DateExpire < (DATE_ADD(curdate(), INTERVAL -1 MONTH)) && DateExpire > (DATE_ADD(curdate(), INTERVAL -2 MONTH)) ORDER BY wp_users . DateExpire ASC", $connection);
