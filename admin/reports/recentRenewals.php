...
$query = mysql_query("SELECT * FROM wp_users WHERE DateRenewed >= (DATE_ADD(curdate(), INTERVAL -1 MONTH)) && DateRenewed <= (DATE_ADD(curdate(), INTERVAL 0 MONTH)) ORDER BY wp_users . lastname", $connection);
